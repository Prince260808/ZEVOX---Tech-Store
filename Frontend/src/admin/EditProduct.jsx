...
export default function EditProduct() {
  ...
  if (errors.fetch) return (
    <div className="text-center py-20">
      ...
      <p className="text-gray-700 font-bold mb-4">{errors.fetch}</p>
      <Link to="/admin/products" className="text-indigo-600 font-semibold hover:underline">← Back to products</Link>
    </div>
  );
    ...
    <div className="max-w-2xl mx-auto space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 truncate">Edit Product</h1>
          <p className="text-sm text-gray-500 hidden sm:block truncate">ID: {id}</p>
        </div>
      </div>
